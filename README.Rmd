...
The base of this package was cloned/forked from the original at [{kaggler}](https://github.com/mkearney/kaggler). From my observations the package is not being maintained and the issues have no response. I have decided to take the developers work and fix the errors that have seemed to pop up over time. Major props and recognition goes out to the original developer(s) of this package.
...
- The original author, Michael Wayne Kearney,  is in no way affiliated with Kaggle.com, and, as such, makes no
assurances that there won't be breaking changes to the API at any time.
- Although I (Michael Wayne Kearney) am not affiliated, it's good practice to be informed, so here is
